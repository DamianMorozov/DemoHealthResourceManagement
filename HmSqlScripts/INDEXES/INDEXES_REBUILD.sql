...
END ELSE BEGIN
	...
	END ELSE BEGIN
		...
		---------------------------------------------------------------------------------------------------------------------
		-- [DOCTORS] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_DOCTORS_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_DOCTORS_DT_CREATE] ON [REF].[DOCTORS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PERSONS_DT_CREATE]';
		END;
		-- [DOCTORS] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_DOCTORS_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_DOCTORS_DT_CHANGE] ON [REF].[DOCTORS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PERSONS_DT_CHANGE]';
		END;
		-- [DOCTORS] & [PERSON_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_DOCTORS_PERSON_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_DOCTORS_PERSON_ID] ON [REF].[DOCTORS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
