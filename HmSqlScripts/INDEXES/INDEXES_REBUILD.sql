...
END ELSE BEGIN
	...
	END ELSE BEGIN
		...
		---------------------------------------------------------------------------------------------------------------------
		-- [EMPLOYEES] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_EMPLOYEES_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_EMPLOYEES_DT_CREATE] ON [REF].[EMPLOYEES] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PERSONS_DT_CREATE]';
		END;
		-- [EMPLOYEES] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_EMPLOYEES_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_EMPLOYEES_DT_CHANGE] ON [REF].[EMPLOYEES] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PERSONS_DT_CHANGE]';
		END;
		-- [EMPLOYEES] & [PERSON_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_EMPLOYEES_PERSON_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_EMPLOYEES_PERSON_ID] ON [REF].[EMPLOYEES] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [AK_PERSONS_PERSON_ID]';
		END;
		---------------------------------------------------------------------------------------------------------------------
		-- [MEDICAL_CARDS] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_MEDICAL_CARDS_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_MEDICAL_CARDS_DT_CREATE] ON [REF].[MEDICAL_CARDS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_MEDICAL_CARDS_DT_CREATE]';
		END;
		-- [MEDICAL_CARDS] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_MEDICAL_CARDS_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_MEDICAL_CARDS_DT_CHANGE] ON [REF].[MEDICAL_CARDS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_MEDICAL_CARDS_DT_CHANGE]';
		END;
		---------------------------------------------------------------------------------------------------------------------
		-- [PATIENTS] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_PATIENTS_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_PATIENTS_DT_CREATE] ON [REF].[PATIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PATIENTS_DT_CREATE]';
		END;
		-- [PATIENTS] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_PATIENTS_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_PATIENTS_DT_CHANGE] ON [REF].[PATIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_PATIENTS_DT_CHANGE]';
		END;
		-- [PATIENTS] & [PERSON_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_PATIENTS_PERSON_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_PATIENTS_PERSON_ID] ON [REF].[PATIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [AK_PATIENTS_PERSON_ID]';
		END;
		-- [PATIENTS] & [MEDICAL_CARD_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_PATIENTS_MEDICAL_CARD_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_PATIENTS_MEDICAL_CARD_ID] ON [REF].[PATIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [AK_PATIENTS_MEDICAL_CARD_ID]';
		END;
		---------------------------------------------------------------------------------------------------------------------
		-- [RECEPTIONS] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_RECEPTIONS_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_RECEPTIONS_DT_CREATE] ON [DIM].[RECEPTIONS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_RECEPTIONS_DT_CREATE]';
		END;
		-- [RECEPTIONS] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_RECEPTIONS_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_RECEPTIONS_DT_CHANGE] ON [DIM].[RECEPTIONS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_RECEPTIONS_DT_CHANGE]';
		END;
		-- [RECEPTIONS] & [PERSON_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_RECEPTIONS_PERSON_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_RECEPTIONS_PERSON_ID] ON [DIM].[RECEPTIONS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [AK_RECEPTIONS_PERSON_ID]';
		END;
		-- [RECEPTIONS] & [DT_START]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_RECEPTIONS_DT_START') IS NOT NULL) BEGIN
			ALTER INDEX [IX_RECEPTIONS_DT_START] ON [DIM].[RECEPTIONS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_RECEPTIONS_DT_START]';
		END;
		---------------------------------------------------------------------------------------------------------------------
	END;
	-- COMMIT
