...
END ELSE BEGIN
	...
	END ELSE BEGIN
		...
		---------------------------------------------------------------------------------------------------------------------
		-- [CLIENTS] & [DT_CREATE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_CLIENTS_DT_CREATE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_CLIENTS_DT_CREATE] ON [REF].[CLIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_CLIENTS_DT_CREATE]';
		END;
		-- [CLIENTS] & [DT_CHANGE]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'IX_CLIENTS_DT_CHANGE') IS NOT NULL) BEGIN
			ALTER INDEX [IX_CLIENTS_DT_CHANGE] ON [REF].[CLIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [IX_CLIENTS_DT_CHANGE]';
		END;
		-- [CLIENTS] & [PERSON_ID]
		IF ((SELECT [INDEX] FROM @INDEXES WHERE [SCHEMA] = @SCHEMA_REF_NAME AND [INDEX] = 'AK_CLIENTS_PERSON_ID') IS NOT NULL) BEGIN
			ALTER INDEX [AK_CLIENTS_PERSON_ID] ON [REF].[CLIENTS] REBUILD PARTITION = ALL 
				WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON);
			PRINT N'[✓] REBUILD INDEX [AK_CLIENTS_PERSON_ID]';
		END;
		---------------------------------------------------------------------------------------------------------------------
	END;
	-- COMMIT
